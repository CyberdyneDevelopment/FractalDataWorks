# Fdw.Web.Search.Clients

The API client for search.
...
| Type | Kind | Purpose |
|---|---|---|
| `SearchApiClient` | class | API client for search endpoints. |

## Installation

```bash
dotnet add package Fdw.Web.Search.Clients --prerelease
```
