...
/// carries an <c>ISecretManagerImplementationConfiguration? Configuration</c> property populated on the read path.
/// </remarks>
public interface ISecretManagerImplementationConfiguration : IImplementationConfiguration
{
