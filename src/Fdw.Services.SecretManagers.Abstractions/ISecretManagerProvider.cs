...
/// Replaces the generic <see cref="IFdwServiceProvider"/> usage with a proper domain-specific interface,
/// eliminating the need for casting when resolving secret managers.
/// </summary>
// Why: SecretManager types previously used generic IFdwServiceProvider with ugly casting.
...
public interface ISecretManagerProvider : IFdwServiceProvider<ISecretManager>
{
}
