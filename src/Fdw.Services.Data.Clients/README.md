...
The API client for DataStore and DataSet management.
...
| Type | Kind | Purpose |
|---|---|---|
| `DataSetApiClient` | class | API client for DataSet management endpoints. |
| `DataStoreApiClient` | class | API client for DataStore management endpoints. |

## Installation

```bash
dotnet add package Fdw.Services.Data.Clients --prerelease
```
