...
/// <summary>
/// The WebMcp domain configuration: names which implementation is configured and holds its settings.
/// </summary>
/// <remarks>
/// WebMcp is its own domain rather than one option of a host, because a host runs it alongside
