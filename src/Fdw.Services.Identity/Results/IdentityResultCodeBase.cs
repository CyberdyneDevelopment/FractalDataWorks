...
/// <summary>
/// Base class for managed identity result codes.
/// </summary>
/// <remarks>
...
public abstract class IdentityResultCodeBase : ResultCodeBase
{
    /// <summary>Initializes a new instance for the Empty sentinel.</summary>
    protected IdentityResultCodeBase()
    {
    }

    /// <summary>Initializes a new instance of the <see cref="IdentityResultCodeBase"/> class with a categorized number.</summary>
    ...
    protected IdentityResultCodeBase(
        ...
        : base(number, name, severity, messageTemplate, "IDENTITY", isRetryable)
    {
    }
}
