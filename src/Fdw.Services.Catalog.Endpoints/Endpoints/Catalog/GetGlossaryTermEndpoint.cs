...
public abstract class GetGlossaryTermEndpoint : Endpoint<GlossaryTermIdRequest, GlossaryTermResponse>
{
    private readonly QualityConfigurationProvider _provider;

    /// <summary>Initializes a new instance of the <see cref="GetGlossaryTermEndpoint"/> class.</summary>
    /// <param name="provider">The configuration provider for quality and catalog data.</param>
    protected GetGlossaryTermEndpoint(QualityConfigurationProvider provider)
    {
        _provider = provider;
    }
