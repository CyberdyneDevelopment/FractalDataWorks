...
public sealed class DefaultAuthorizationService : IFrameworkAuthorizationService
{
    ...
    public DefaultAuthorizationService(
        IImplementationConfigurationProvider<IRoleImplementationConfiguration> roleProvider,
        IImplementationConfigurationProvider<IPermissionImplementationConfiguration> permissionProvider,
        IImplementationConfigurationProvider<IRolePermissionImplementationConfiguration> rolePermissionProvider,
