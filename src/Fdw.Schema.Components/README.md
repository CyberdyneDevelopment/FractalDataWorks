# Fdw.Schema.Components

Headless components for schema browsing.
...
```bash
dotnet add package Fdw.Schema.Components --prerelease
```

## Dependencies

`Fdw.MessageLogging.Abstractions` · `Fdw.Results` · `Fdw.Schema.Clients` · `Fdw.Services.Data.Clients` · `Fdw.UI.Components`
