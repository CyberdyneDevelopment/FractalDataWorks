...
The API client for theme management.
...
| Type | Kind | Purpose |
|---|---|---|
| `ThemeApiClient` | class | API client for theme management endpoints. |

## Installation

```bash
dotnet add package Fdw.UI.Themes.Clients --prerelease
```

## Dependencies

`Fdw.UI.Themes.Abstractions` · `Fdw.Web.Clients` · `Fdw.Web.Endpoints` · `Fdw.Web.Http.Authentication`
