...
/// <summary>Message logging for <see cref="Fdw.Sql.Commands.Search.Translators.FindDuplicatesTranslator"/>.</summary>
...
public static partial class FindDuplicatesTranslatorLog
{
    ...
    [MessageLogging(
        ...
        Message = "FindDuplicatesTranslator translating {commandType}")]
    ...
    [MessageLogging(
        ...
        Message = "FindDuplicatesTranslator for {commandType} is registered but not yet implemented")]
