...
/// <summary>Message logging for <see cref="Fdw.Sql.Commands.Build.Translators.GetCompilationOptionsTranslator"/>.</summary>
...
public static partial class GetCompilationOptionsTranslatorLog
{
    ...
    [MessageLogging(
        ...
        Message = "GetCompilationOptionsTranslator translating {commandType}")]
    ...
    [MessageLogging(
        ...
        Message = "GetCompilationOptionsTranslator for {commandType} is registered but not yet implemented")]
