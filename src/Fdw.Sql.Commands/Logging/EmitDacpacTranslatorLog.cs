...
/// <summary>Message logging for <see cref="Fdw.Sql.Commands.Build.Translators.EmitDacpacTranslator"/>.</summary>
[MessageLoggingTypeCode("SQL")]
public static partial class EmitDacpacTranslatorLog
{
    /// <summary>Logs translator entry.</summary>
    [MessageLogging(
        EventId = 11008,
        Level = LogLevel.Trace,
        Message = "EmitDacpacTranslator translating {commandType}")]
    ...
    [MessageLogging(
        ...
        Message = "EmitDacpacTranslator for {commandType} is registered but not yet implemented")]
