...
/// <summary>Message logging for <see cref="Fdw.Sql.Commands.Navigation.Translators.FindDefinitionTranslator"/>.</summary>
...
public static partial class FindDefinitionTranslatorLog
{
    ...
    [MessageLogging(
        ...
        Message = "FindDefinitionTranslator translating {commandType}")]
    ...
    [MessageLogging(
        ...
        Message = "FindDefinitionTranslator for {commandType} is registered but not yet implemented")]
