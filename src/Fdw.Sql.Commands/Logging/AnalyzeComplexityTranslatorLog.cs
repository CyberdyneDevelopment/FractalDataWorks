...
/// <summary>Message logging for <see cref="Fdw.Sql.Commands.Analysis.Translators.AnalyzeComplexityTranslator"/>.</summary>
...
public static partial class AnalyzeComplexityTranslatorLog
{
    ...
    [MessageLogging(
        ...
        Message = "AnalyzeComplexityTranslator translating {commandType}")]
    ...
    [MessageLogging(
        ...
        Message = "AnalyzeComplexityTranslator for {commandType} is registered but not yet implemented")]
