...
/// <summary>Message logging for <see cref="Fdw.Sql.Commands.Refactoring.Translators.InlineVariableTranslator"/>.</summary>
...
public static partial class InlineVariableTranslatorLog
{
    ...
    [MessageLogging(
        ...
        Message = "InlineVariableTranslator translating {commandType}")]
    ...
    [MessageLogging(
        ...
        Message = "InlineVariableTranslator for {commandType} is registered but not yet implemented")]
