...
/// <summary>Message logging for <see cref="Fdw.Sql.Commands.Refactoring.Translators.ExtractViewTranslator"/>.</summary>
[MessageLoggingTypeCode("SQL")]
public static partial class ExtractViewTranslatorLog
{
    /// <summary>Logs translator entry.</summary>
    [MessageLogging(
        EventId = 11032,
        Level = LogLevel.Trace,
        Message = "ExtractViewTranslator translating {commandType}")]
    ...
    [MessageLogging(
        ...
        Message = "ExtractViewTranslator for {commandType} is registered but not yet implemented")]
