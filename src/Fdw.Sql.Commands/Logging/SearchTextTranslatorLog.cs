...
/// <summary>Message logging for <see cref="Fdw.Sql.Commands.Search.Translators.SearchTextTranslator"/>.</summary>
...
public static partial class SearchTextTranslatorLog
{
    ...
    [MessageLogging(
        ...
        Message = "SearchTextTranslator translating {commandType}")]
    ...
    [MessageLogging(
        ...
        Message = "SearchTextTranslator for {commandType} is registered but not yet implemented")]
