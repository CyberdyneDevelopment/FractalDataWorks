# Fdw.Services.Settings.Clients

The API client for server settings.
...
| Type | Kind | Purpose |
|---|---|---|
| `SettingsApiClient` | class | API client for server settings operations. |

## Payloads

| Type | Kind | Purpose |
|---|---|---|
| `UpdateServerSettingPayload` | class | Request to update a server setting value. |

## Installation

```bash
dotnet add package Fdw.Services.Settings.Clients --prerelease
```
