...
/// <summary>
/// Implementation for the Settings API client.
/// </summary>
...
[Implementation(typeof(ApiClientTypes), "SettingsClient")]
    ...
    public SettingsClientType() : base("SettingsClient", "Settings API Client") {
        ...
        Registration((builder, loggerFactory) =>
        {
            builder.Services.AddScoped<SettingsApiClient>(sp =>
            {
                ...
                return new SettingsApiClient(sp.GetRequiredService<IHttpClientFactory>().CreateClient(Name), logger);
            });
            return GenericResult<IHostApplicationBuilder>.Success(builder);
        });
 }
