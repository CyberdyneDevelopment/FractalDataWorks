...
/// <see cref="Fdw.ServiceTypes.IDomainServiceProvider{TService, TConfiguration}"/>. Consumers that need
/// this kind of service MUST inject its <c>IDomainServiceProvider&lt;TService, TConfiguration&gt;</c> and
