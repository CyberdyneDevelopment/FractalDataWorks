...
/// <see cref="Fdw.ServiceTypes.IFdwServiceProvider{TService, TConfiguration}"/>. Consumers that need
/// this kind of service MUST inject its <c>IFdwServiceProvider&lt;TService, TConfiguration&gt;</c> and
