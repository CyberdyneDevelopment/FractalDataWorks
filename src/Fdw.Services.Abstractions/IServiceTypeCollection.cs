...
public interface IServiceTypeCollection
{
    ...
    /// </summary>
    Func<IHostApplicationBuilder, ILoggerFactory?, bool, bool, IGenericResult<IHostApplicationBuilder>> Configure { get; }

    /// <summary>The collection's phase-2 Register entry point (e.g. <c>ConnectionTypes.Register</c>).</summary>
    Func<IHostApplicationBuilder, ILoggerFactory?, bool, bool, IGenericResult<IHostApplicationBuilder>> Register { get; }

    /// <summary>The collection's phase-3 Initialize entry point (e.g. <c>ConnectionTypes.Initialize</c>).</summary>
    Func<IHost, ILoggerFactory?, bool, bool, IGenericResult<IHost>> Initialize { get; }
}
