...
/// <summary>
/// Source-generated logging methods for <see cref="DataSetFactory"/>.
/// EventId range: 5400-5419.
/// </summary>
[MessageLoggingTypeCode("DATA")]
public static partial class DataSetFactoryLog
{
    /// <summary>Traces entry into DataSetFactory.Create.</summary>
    [MessageLogging(EventId = 11064, Level = LogLevel.Trace,
        Message = "DataSetFactory creating runtime for DataSet '{dataSetName}'")]
    ...
    [MessageLogging(EventId = 21002, Level = LogLevel.Error,
        Message = "DataSetFactory.Create failed: DataSetConfiguration.Name is required")]
    ...
    [MessageLogging(EventId = 91008, Level = LogLevel.Error,
        Message = "DataSetFactory.Create failed for '{dataSetName}': source resolution returned failure")]
    ...
    [MessageLogging(EventId = 91009, Level = LogLevel.Error,
        Message = "DataSetFactory.Create failed for '{dataSetName}': join build error — {reason}")]
