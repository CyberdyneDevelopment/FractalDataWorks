...
public sealed class MainDataGatewayImplementation : DataGatewayTypeBase<IGenericService, IDataGatewayFactory>
{
            ...
            "The data gateway this framework ships, with DataStoreProvider, SchemaInformation and DataSetResolver")
    {
        ...
        {
            builder.Services.AddSingleton<IMainDataGatewayConfigurationProvider, MainDataGatewayConfigurationProvider>(sp => new MainDataGatewayConfigurationProvider(sp.GetRequiredService<ILogger<MainDataGatewayConfigurationProvider>>(), sp.GetRequiredService<IConfigurationGatewayProvider>(), DataGatewayServiceTypes.ConfigurationConnection));
