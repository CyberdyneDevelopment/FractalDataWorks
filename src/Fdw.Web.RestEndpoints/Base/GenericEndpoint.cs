...
public abstract class GenericEndpoint<TRequest, TResponse> : Endpoint<TRequest, TResponse>
    where TRequest : notnull
{
    ...
    public override async Task HandleAsync(TRequest req, CancellationToken ct)
    {
        ...
        Logger = Resolve<ILogger<GenericEndpoint<TRequest, TResponse>>>();
...
/// </summary>
/// <typeparam name="TResponse">The response type.</typeparam>
public abstract class GenericEndpoint<TResponse> : GenericEndpoint<EmptyRequest, TResponse>
{
}