...
/// Extends CrudListEndpoint with request-based filtering, pagination,
...
/// <typeparam name="TSummary">The summary DTO type returned in the list.</typeparam>
public abstract class CrudListEndpoint<TListRequest, TSummary> : Endpoint<TListRequest, List<TSummary>>
