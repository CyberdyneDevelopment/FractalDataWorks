...
public abstract class DeleteByPropertyEndpointBase<TResource, TKey>
    ...
    where TKey : notnull
{
    /// <summary>Initializes a new instance of the <see cref="DeleteByPropertyEndpointBase{TResource, TKey}"/> class.</summary>
    protected DeleteByPropertyEndpointBase(ILogger<DeleteByPropertyEndpointBase<TResource, TKey>> logger) : base(logger)
    {
    }
