...
public static partial class ConnectionConfigurationProviderLog
{
    ...
    /// <param name="implementation">The service option type the typed connection provider was registered for.</param>
    /// <returns>The structured <see cref="IGenericMessage"/> for the event.</returns>
    [MessageLogging(EventId = 11000, Level = LogLevel.Trace,
        Message = "Registering typed connection provider for service option type '{implementation}'")]
    ...
    /// <param name="implementation">The service option type used to load the typed connection body.</param>
    /// <returns>The structured <see cref="IGenericMessage"/> for the event.</returns>
    [MessageLogging(EventId = 11001, Level = LogLevel.Trace,
        Message = "Loading typed connection body for connection '{name}' using service option type '{implementation}'")]
    ...
    /// </summary>
    /// <param name="logger">The logger that records the event.</param>
    /// <param name="implementation">The service option type for which no typed connection provider was found.</param>
    ...
    [MessageLogging(EventId = 61000, Level = LogLevel.Error,
        Message = "No typed connection provider registered for service option type '{implementation}' (connection '{name}')")]
    ...
    [MessageLogging(EventId = 71000, Level = LogLevel.Error,
        Message = "Failed to load typed connection body for connection '{name}' (service option type '{implementation}')")]
    ...
    /// <summary>
    /// Logs that a connection header has no Implementation, so its typed body cannot be loaded.
    /// </summary>
    /// <param name="logger">The logger that records the event.</param>
    /// <param name="name">The name of the connection header missing a Implementation.</param>
    /// <returns>The structured <see cref="IGenericMessage"/> for the event.</returns>
    [MessageLogging(EventId = 61001, Level = LogLevel.Error,
        Message = "Connection header '{name}' has no Implementation — typed body cannot be loaded")]
    ...
    [MessageLogging(EventId = 11002, Level = LogLevel.Trace,
        Message = "Typed connection body loaded for connection '{name}' (service option type '{implementation}')")]
