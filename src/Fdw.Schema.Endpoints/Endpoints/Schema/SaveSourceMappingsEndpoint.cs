...
/// </remarks>
public abstract class SaveSourceMappingsEndpoint : Endpoint<SaveSourceMappingsRequest, List<FieldMappingResponsePayload>>
{
    // Why: IDataGateway retained for FieldMapping child record operations only.
    private readonly IDataGateway _dataGateway;
    private readonly DataSetConfigurationProvider _dataSetProvider;
    private readonly ILogger<SaveSourceMappingsEndpoint> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="SaveSourceMappingsEndpoint"/> class.
    /// </summary>
    protected SaveSourceMappingsEndpoint(
        IDataGateway dataGateway,
        DataSetConfigurationProvider dataSetProvider,
        ILogger<SaveSourceMappingsEndpoint> logger)
    {
        _dataGateway = dataGateway;
        _dataSetProvider = dataSetProvider;
        _logger = logger ?? NullLogger<SaveSourceMappingsEndpoint>.Instance;
    }
