...
public partial class ApiReferenceConfiguration : IApiReferenceConfiguration
{
    ...
    /// <summary>Gets or sets the option name selecting which ApiReference implementation is configured.</summary>
    ...
    public IApiReferenceImplementationConfiguration? Configuration { get; set; }

    /// <inheritdoc />
    IImplementationConfiguration? IDomainConfiguration.ImplementationConfiguration
    {
        get => Configuration;
        set => Configuration = (IApiReferenceImplementationConfiguration?)value;
    }
}
