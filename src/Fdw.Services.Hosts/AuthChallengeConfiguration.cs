...
public partial class AuthChallengeConfiguration : IAuthChallengeConfiguration
{
    ...
    /// <summary>Gets or sets the option name selecting which AuthChallenge implementation is configured.</summary>
    ...
    public IAuthChallengeImplementationConfiguration? Configuration { get; set; }

    /// <inheritdoc />
    IImplementationConfiguration? IDomainConfiguration.ImplementationConfiguration
    {
        get => Configuration;
        set => Configuration = (IAuthChallengeImplementationConfiguration?)value;
    }
}
