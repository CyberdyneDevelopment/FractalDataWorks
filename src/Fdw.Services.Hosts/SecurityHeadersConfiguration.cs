...
public partial class SecurityHeadersConfiguration : ISecurityHeadersConfiguration
{
    ...
    /// <summary>Gets or sets the option name selecting which SecurityHeaders implementation is configured.</summary>
    ...
    public ISecurityHeadersImplementationConfiguration? Configuration { get; set; }

    /// <inheritdoc />
    IImplementationConfiguration? IDomainConfiguration.ImplementationConfiguration
    {
        get => Configuration;
        set => Configuration = (ISecurityHeadersImplementationConfiguration?)value;
    }
}
