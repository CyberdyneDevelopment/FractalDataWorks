...
/// <summary>
/// Computes the maximum value from a set of field values, optionally grouped by one or more fields.
/// </summary>
[TypeOption(typeof(CalculationOperationTypes), "Max")]
[ExcludeFromCodeCoverage]
public sealed class MaxOperation : CalculationOperationBase
{
    private readonly ILogger<MaxOperation> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="MaxOperation"/> class.
    /// </summary>
    public MaxOperation()
        : base(id: 13, name: "Max", category: "Aggregate", description: "Computes the maximum value from a set of values")
    {
        _logger = NullLogger<MaxOperation>.Instance;
        Parameters =
        [
            new OperationParameterDefinition { Name = "Values", Kind = "Field", IsRequired = true, DisplayName = "Values Field", HelpText = "The field containing numeric values to find the maximum of" },
