...
/// <summary>
/// Computes the minimum value from a set of field values, optionally grouped by one or more fields.
/// </summary>
[TypeOption(typeof(CalculationOperationTypes), "Min")]
[ExcludeFromCodeCoverage]
public sealed class MinOperation : CalculationOperationBase
{
    private readonly ILogger<MinOperation> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="MinOperation"/> class.
    /// </summary>
    public MinOperation()
        : base(id: 12, name: "Min", category: "Aggregate", description: "Computes the minimum value from a set of values")
    {
        _logger = NullLogger<MinOperation>.Instance;
        Parameters =
        [
            new OperationParameterDefinition { Name = "Values", Kind = "Field", IsRequired = true, DisplayName = "Values Field", HelpText = "The field containing numeric values to find the minimum of" },
