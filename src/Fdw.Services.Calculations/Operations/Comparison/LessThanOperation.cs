...
/// <summary>
/// Compares whether the left field value is less than the right scalar value.
/// Returns <see langword="true"/> or <see langword="false"/> as the result.
/// </summary>
[TypeOption(typeof(CalculationOperationTypes), "LessThan")]
[ExcludeFromCodeCoverage]
public sealed class LessThanOperation : CalculationOperationBase
{
    private readonly ILogger<LessThanOperation> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="LessThanOperation"/> class.
    /// </summary>
    public LessThanOperation()
        : base(id: 21, name: "LessThan", category: "Comparison", description: "Returns true if the left value is less than the right value")
    {
        _logger = NullLogger<LessThanOperation>.Instance;
        Parameters =
        [
