...
/// <summary>
/// Multiplies two field values together (left * right).
/// </summary>
[TypeOption(typeof(CalculationOperationTypes), "Multiply")]
[ExcludeFromCodeCoverage]
public sealed class MultiplyOperation : CalculationOperationBase
{
    private readonly ILogger<MultiplyOperation> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiplyOperation"/> class.
    /// </summary>
    public MultiplyOperation()
        : base(id: 3, name: "Multiply", category: "Arithmetic", description: "Multiplies two values (left * right)")
    {
        _logger = NullLogger<MultiplyOperation>.Instance;
        Parameters =
        [
