...
FDW046 | Design | Warning | InlineStyleAttributeAnalyzer - Inline style declaration the host theme cannot override
FDW047 | Design | Warning | RawSvgMarkupAnalyzer - Raw svg icon glyph in Razor markup
