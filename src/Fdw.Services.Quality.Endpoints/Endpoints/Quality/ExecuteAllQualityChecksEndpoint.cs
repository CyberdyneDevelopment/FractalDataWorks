...
// Why: ExecuteAllQualityChecksEndpoint is a RUNTIME EXECUTION endpoint, not a configuration endpoint.
...
public abstract class ExecuteAllQualityChecksEndpoint : Endpoint<DataSetQueryRequest, List<QualityCheckResultResponse>>
{
    private readonly QualityConfigurationProvider _provider;
    private readonly IDataGateway _dataGateway;

    /// <summary>Initializes a new instance of the <see cref="ExecuteAllQualityChecksEndpoint"/> class.</summary>
    ...
    protected ExecuteAllQualityChecksEndpoint(QualityConfigurationProvider provider, IDataGateway dataGateway)
    {
        _provider = provider;
