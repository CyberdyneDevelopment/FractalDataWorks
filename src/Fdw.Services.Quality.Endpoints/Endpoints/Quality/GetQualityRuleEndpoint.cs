...
public abstract class GetQualityRuleEndpoint : Endpoint<QualityRuleIdRequest, QualityRuleDto>
{
    private readonly QualityConfigurationProvider _provider;

    /// <summary>Initializes a new instance of the <see cref="GetQualityRuleEndpoint"/> class.</summary>
    /// <param name="provider">The configuration provider for quality and catalog data.</param>
    protected GetQualityRuleEndpoint(QualityConfigurationProvider provider)
    {
        _provider = provider;
    }
