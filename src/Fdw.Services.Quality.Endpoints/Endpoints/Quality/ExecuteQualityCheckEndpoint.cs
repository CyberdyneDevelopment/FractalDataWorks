...
// Why: ExecuteQualityCheckEndpoint is a RUNTIME EXECUTION endpoint, not a configuration endpoint.
...
public abstract class ExecuteQualityCheckEndpoint : Endpoint<QualityRuleIdRequest, QualityCheckResultResponse>
{
    private readonly QualityConfigurationProvider _provider;
    private readonly IDataGateway _dataGateway;

    /// <summary>Initializes a new instance of the <see cref="ExecuteQualityCheckEndpoint"/> class.</summary>
    ...
    protected ExecuteQualityCheckEndpoint(QualityConfigurationProvider provider, IDataGateway dataGateway)
    {
        _provider = provider;
