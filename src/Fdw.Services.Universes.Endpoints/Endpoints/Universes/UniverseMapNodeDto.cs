...
/// <summary>One resource attached to a universe, as a node on its map.</summary>
/// <remarks>
...
/// </remarks>
public class UniverseMapNodeDto
{
    ...
    /// <remarks>
    /// An open string, not a closed set. universe.UniverseResource.ResourceType carries no CHECK
    ...
    /// <summary>Gets or sets how the universe holds this resource — owned, or merely used.</summary>
