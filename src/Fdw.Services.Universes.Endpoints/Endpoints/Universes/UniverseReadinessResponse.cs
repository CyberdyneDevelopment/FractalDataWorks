...
/// <summary>How much of a universe is backed by real data.</summary>
/// <remarks>
...
///
/// A single object rather than a list envelope: this is one universe's readiness.
/// </remarks>
public class UniverseReadinessResponse
{
    ...
    /// <summary>Gets or sets whether the universe can answer a query at all, stand-ins included.</summary>
    public bool Queryable { get; set; }

    /// <summary>Gets or sets whether the universe can produce physical tables.</summary>
    /// <remarks>
