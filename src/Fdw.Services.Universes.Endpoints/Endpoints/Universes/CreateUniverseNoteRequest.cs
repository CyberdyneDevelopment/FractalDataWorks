...
/// <remarks>
/// Deliberately three fields. The author comes from the token, the universe from the route and the
/// timestamp from the server clock — if a client can send an author or a time, a client can lie
/// about both.
/// </remarks>
public class CreateUniverseNoteRequest
{
    /// <summary>Gets or sets the universe the note is raised in, from the route.</summary>
