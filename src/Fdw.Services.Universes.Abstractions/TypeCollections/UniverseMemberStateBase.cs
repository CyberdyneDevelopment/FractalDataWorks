...
/// </remarks>
public abstract class UniverseMemberStateBase : TypeOptionBase<UniverseMemberStateBase>, IUniverseMemberState
{
    /// <summary>Initializes a new instance of the <see cref="UniverseMemberStateBase"/> class.</summary>
    ...
    protected UniverseMemberStateBase(string name, bool grantsMembership) : base(name)
    {
