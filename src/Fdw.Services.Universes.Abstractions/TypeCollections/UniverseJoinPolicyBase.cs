...
/// <summary>Base for What happens when someone asks to join a universe.</summary>
/// <remarks>
...
/// </remarks>
public abstract class UniverseJoinPolicyBase : TypeOptionBase<UniverseJoinPolicyBase>, IUniverseJoinPolicy
{
    /// <summary>Initializes a new instance of the <see cref="UniverseJoinPolicyBase"/> class.</summary>
    /// <param name="name">The option name, which is the value persisted.</param>
    protected UniverseJoinPolicyBase(string name) : base(name)
    {
    }
}
