...
[TypeOption(typeof(EndpointTypes), "CommandEndpointBase", RestrictToCurrentCompilation = true)]
public sealed class CommandEndpointBase : EndpointTypeBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CommandEndpointBase"/> class.
    /// </summary>
    public CommandEndpointBase() : base(
        id: 3,
        name: "CommandEndpointBase",
