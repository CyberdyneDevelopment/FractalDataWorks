...
/// IExternalIdentityProviderImplementationConfiguration? Configuration</c> property populated on the read path,
/// mirroring <c>ITokenManagerImplementationConfiguration</c>/<c>TokenManagerConfiguration</c>.
/// </summary>
public interface IExternalIdentityProviderImplementationConfiguration : IImplementationConfiguration
{
    /// <summary>
