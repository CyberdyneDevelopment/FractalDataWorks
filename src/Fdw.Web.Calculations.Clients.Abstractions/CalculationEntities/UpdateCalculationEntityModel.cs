...
/// Mirrors the server-side <c>UpdateCalculationEntityRequest</c> endpoint contract.
/// </summary>
public sealed class UpdateCalculationEntityModel
{
    /// <summary>
    /// Gets or sets the calculation entity ID to update.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the updated calculation entity type name (e.g. "Formula", "Windowed").
    /// </summary>
    public string CalculationEntityType { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the updated input declarations.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets whether the entity should be enabled.
    /// </summary>
