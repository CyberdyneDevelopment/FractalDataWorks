...
/// </remarks>
public abstract class GetConfigurationTypesByCategoryEndpoint : CrudListEndpoint<GetTypesByCategoryRequest, ConfigurationTypeSummaryDto>
{
    ...
    protected GetConfigurationTypesByCategoryEndpoint(IConfigurationContainerLookup containerLookup)
    {
