...
/// </remarks>
public abstract class GetConfigurationTypeDetailEndpoint : CrudGetEndpoint<GetTypeDetailRequest, ConfigurationTypeDetailDto>
{
    ...
    protected GetConfigurationTypeDetailEndpoint(IConfigurationContainerLookup containerLookup)
    {
