...
/// <summary>Initializes a new instance of the endpoint.</summary>
    protected GetConfigurationTypesByCategoryEndpointBase(ILogger<GetConfigurationTypesByCategoryEndpointBase> logger, IConfigurationContainerLookup containerLookup) : base(logger)
    {
