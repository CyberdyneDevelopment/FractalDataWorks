...
/// </remarks>
public abstract class GetConfigurationCategoriesEndpoint : CrudListEndpoint<string>
{
    ...
    protected GetConfigurationCategoriesEndpoint(IConfigurationContainerLookup containerLookup)
    {
