...
/// </remarks>
public abstract class GetRootConfigurationTypesEndpoint : CrudListEndpoint<ConfigurationTypeSummaryDto>
{
    ...
    protected GetRootConfigurationTypesEndpoint(IConfigurationContainerLookup containerLookup)
    {
