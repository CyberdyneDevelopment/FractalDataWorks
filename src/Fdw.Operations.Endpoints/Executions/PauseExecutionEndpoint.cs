...
/// </summary>
public abstract class PauseExecutionEndpoint : Endpoint<ExecutionStateRequest, ExecutionDetailDto>
{
    private readonly IExecutionTracker _tracker;

    /// <summary>
    /// Initializes a new instance of the <see cref="PauseExecutionEndpoint"/> class.
    /// </summary>
    protected PauseExecutionEndpoint(IExecutionTracker tracker)
    {
        _tracker = tracker;
    }
