...
/// </summary>
public abstract class GetExecutionEventsEndpointBase : Endpoint<ExecutionIdRequest, List<ExecutionEventDto>>
{
    private readonly IExecutionTracker _tracker;

    /// <summary>
    /// Initializes a new instance of the <see cref="GetExecutionEventsEndpointBase"/> class.
    /// </summary>
    protected GetExecutionEventsEndpointBase(ILogger logger, IExecutionTracker tracker)
    {
