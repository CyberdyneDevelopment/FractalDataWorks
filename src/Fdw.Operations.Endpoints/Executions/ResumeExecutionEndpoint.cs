...
/// </summary>
public abstract class ResumeExecutionEndpoint : Endpoint<ExecutionStateRequest, ExecutionDetailDto>
{
    private readonly IExecutionTracker _tracker;

    /// <summary>
    /// Initializes a new instance of the <see cref="ResumeExecutionEndpoint"/> class.
    /// </summary>
    protected ResumeExecutionEndpoint(IExecutionTracker tracker)
    {
        _tracker = tracker;
    }
