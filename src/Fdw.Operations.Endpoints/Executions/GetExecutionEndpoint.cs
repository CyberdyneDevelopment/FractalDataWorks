...
/// </summary>
public abstract class GetExecutionEndpoint : Endpoint<ExecutionIdRequest, ExecutionDetailDto>
{
    private readonly IExecutionTracker _tracker;

    /// <summary>
    /// Initializes a new instance of the <see cref="GetExecutionEndpoint"/> class.
    /// </summary>
    protected GetExecutionEndpoint(IExecutionTracker tracker)
    {
        _tracker = tracker;
    }
