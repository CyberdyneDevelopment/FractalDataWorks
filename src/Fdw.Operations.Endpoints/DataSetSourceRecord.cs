...
public partial class DataSetSourceRecord
{
    ...
    /// <summary>Gets or sets the logical Id of the DataSet this source derives from, if resolved.</summary>
    public Guid? SourceDataSetId { get; set; }
    /// <summary>Gets or sets the name of the DataSet this source derives from (drives the DerivesFrom lineage edge).</summary>
