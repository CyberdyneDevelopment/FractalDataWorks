...
/// <summary>A declared relationship between two data sets in a dataverse.</summary>
/// <remarks>Shaped to match <c>DataflowEdgeDto</c>, plus <see cref="IsDefined"/>.</remarks>
public class DataverseMapEdgeDto
{
    ...
    /// <remarks>
    /// A stored fact rather than a derivation: dataverse.DataverseRelationship.LeftFieldId and
