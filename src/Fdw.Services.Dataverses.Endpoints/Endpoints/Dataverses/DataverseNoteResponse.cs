...
/// <summary>A note raised inside a dataverse.</summary>
/// <remarks>
...
/// </remarks>
public class DataverseNoteResponse
{
    ...
    /// <remarks>
    /// A Guid, not a name: dataverse.Note.SubjectId is a non-nullable uniqueidentifier, so the
    ...
    /// looked it up. Resolved for DataSet and Dataverse, which are one lookup each; omitted for the
