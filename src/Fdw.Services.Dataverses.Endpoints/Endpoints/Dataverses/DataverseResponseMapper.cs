...
internal static class DataverseResponseMapper
{
    ...
    internal static DataverseSummaryResponse ToSummary(IDataverseImplementationConfiguration config) => new()
    {
        Id = config.Id,
        Name = config.Name,
    ...
    /// <param name="config">The dataverse configuration.</param>
    internal static DataverseDetailResponse ToDetail(IDataverseImplementationConfiguration config) => new()
    {
        Id = config.Id,
        Name = config.Name,
        DisplayName = config.DisplayName,
