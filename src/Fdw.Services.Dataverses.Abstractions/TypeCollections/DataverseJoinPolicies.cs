...
/// <remarks>
/// Paired with visibility: a Discoverable dataverse someone cannot ask to join is a dead end, and an Open one that auto-approves has no gate at all. The pairing is the caller's to choose — neither value is defaulted.
///
...
[TypeCollection(typeof(DataverseJoinPolicyBase), typeof(IDataverseJoinPolicy), typeof(DataverseJoinPolicies))]
public abstract partial class DataverseJoinPolicies : TypeCollectionBase<DataverseJoinPolicyBase, IDataverseJoinPolicy>
{
}
