...
/// <summary>
/// The kinds of resource that can be attached to a dataverse.
/// </summary>
/// <remarks>
/// <para>
...
/// referenced. A host with no pipeline packages cannot attach a pipeline to a dataverse, which is
/// correct rather than unfortunate.
/// </para>
/// <para>
/// This is why <c>dataverse.DataverseResource.ResourceType</c> carries no CHECK constraint. A closed
...
[TypeCollection(typeof(DataverseResourceKindBase), typeof(IDataverseResourceKind), typeof(DataverseResourceKinds))]
public abstract partial class DataverseResourceKinds
    : TypeCollectionBase<DataverseResourceKindBase, IDataverseResourceKind>
{
    /// <summary>Gets the service category this collection belongs to.</summary>
    public static string ServiceCategory => "Dataverse";
}
