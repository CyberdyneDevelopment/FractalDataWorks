...
public abstract class ListGlossaryTermsEndpoint : EndpointWithoutRequest<List<GlossaryTermResponse>>
{
    private readonly QualityConfigurationProvider _provider;

    /// <summary>Initializes a new instance of the <see cref="ListGlossaryTermsEndpoint"/> class.</summary>
    /// <param name="provider">The configuration provider for quality and catalog data.</param>
    protected ListGlossaryTermsEndpoint(QualityConfigurationProvider provider)
    {
        _provider = provider;
    }
