...
public abstract class ResolveDataSetAnnotationEndpoint : Endpoint<DataSetAnnotationIdRequest, DataSetAnnotationPayload>
{
    private readonly QualityConfigurationProvider _provider;

    /// <summary>Initializes a new instance of the <see cref="ResolveDataSetAnnotationEndpoint"/> class.</summary>
    /// <param name="provider">The configuration provider for quality and catalog data.</param>
    protected ResolveDataSetAnnotationEndpoint(QualityConfigurationProvider provider)
    {
        _provider = provider;
    }
