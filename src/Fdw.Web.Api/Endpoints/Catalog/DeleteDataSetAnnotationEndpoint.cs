...
public abstract class DeleteDataSetAnnotationEndpoint : Endpoint<DataSetAnnotationIdRequest>
{
    private readonly QualityConfigurationProvider _provider;

    /// <summary>Initializes a new instance of the <see cref="DeleteDataSetAnnotationEndpoint"/> class.</summary>
    /// <param name="provider">The configuration provider for quality and catalog data.</param>
    protected DeleteDataSetAnnotationEndpoint(QualityConfigurationProvider provider)
    {
        _provider = provider;
    }
