...
public abstract class UpdateGlossaryTermEndpoint : Endpoint<GlossaryTermResponse, GlossaryTermResponse>
{
    private readonly QualityConfigurationProvider _provider;

    /// <summary>Initializes a new instance of the <see cref="UpdateGlossaryTermEndpoint"/> class.</summary>
    /// <param name="provider">The configuration provider for quality and catalog data.</param>
    protected UpdateGlossaryTermEndpoint(QualityConfigurationProvider provider)
    {
        _provider = provider;
    }
