...
public abstract class ListQualityRulesEndpoint : Endpoint<DataSetQueryRequest, List<QualityRuleDto>>
{
    private readonly QualityConfigurationProvider _provider;

    /// <summary>Initializes a new instance of the <see cref="ListQualityRulesEndpoint"/> class.</summary>
    /// <param name="provider">The configuration provider for quality and catalog data.</param>
    protected ListQualityRulesEndpoint(QualityConfigurationProvider provider)
    {
        _provider = provider;
    }
