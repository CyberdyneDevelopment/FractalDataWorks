...
/// </summary>
public abstract class TestConnectionEndpoint : Endpoint<TestConnectionRequest, TestConnectionResponse>
{
    ...
    /// <inheritdoc />
    protected TestConnectionEndpoint(
        ...
        ILogger<TestConnectionEndpoint> logger)
    {
        ...
        _logger = logger ?? NullLogger<TestConnectionEndpoint>.Instance;
    }
