...
/// <summary>
/// Builds the StreamingPipeline implementation.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class StreamingPipelineProvider
    : ImplementationServiceProviderBase<IEtlPipeline, IPipelineImplementationConfiguration>,
      IStreamingPipelineProvider
{
    private readonly IStreamingPipelineFactory _factory;

    /// <summary>
    /// Initializes a new instance of the <see cref="StreamingPipelineProvider"/> class.
    /// </summary>
    /// <param name="factory">Builds the service.</param>
    public StreamingPipelineProvider(IStreamingPipelineFactory factory) => _factory = factory;
