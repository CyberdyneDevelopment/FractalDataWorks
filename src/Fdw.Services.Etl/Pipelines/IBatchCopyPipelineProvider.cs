...
/// <summary>
/// The BatchCopyPipeline implementation of its domain.
/// </summary>
/// <remarks>
/// A per-option interface for the same reason <c>IBatchCopyPipelineFactory</c> has one: each implementation
/// closes its base with its OWN interface, and that is what the domain provider registers against.
/// </remarks>
public interface IBatchCopyPipelineProvider
