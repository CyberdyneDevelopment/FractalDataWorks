    ...
    static EtlPipelineTypes()
    {
        ...
        Registration((builder, loggerFactory) =>
        {
            ...
            builder.Services.AddScoped<IEtlPipelineProvider>(sp =>
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ServiceTypeLog.DomainHasNoConfigurationSource(
                            ...
                            typeof(IImplementationConfigurationProvider<IPipelineImplementationConfiguration>).ToString());
                    }
                }
                catch (Exception ex)
                {
                ...
                // that ever builds an EtlPipelineProvider, not only root's.
                foreach (var option in Options)
                {
                    if (option is not IEtlPipelineType etlPipelineOption)
                        continue;

                    etlPipelineOption.RegisterImplementationProvider(provider, sp, stLogger);
                }
