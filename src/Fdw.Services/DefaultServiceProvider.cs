...
/// </remarks>
public class DefaultServiceProvider<TService, TConfiguration, TImplementationConfiguration, TFactory, TConfigurationProvider>
    : PlatformServiceProviderBase<TService, TConfiguration, TImplementationConfiguration, TFactory, TConfigurationProvider>
    ...
    where TConfigurationProvider : IDomainConfigurationProvider<TConfiguration, TImplementationConfiguration>
{
    ...
    /// <see cref="DefaultServiceProvider{TService, TConfiguration, TImplementationConfiguration, TFactory, TConfigurationProvider}"/> class.
    /// </summary>
