...
{
    private readonly IScheduleConfigurationProvider _provider;

    /// <inheritdoc />
    protected ListSchedulesEndpointBase(ILogger<ListSchedulesEndpointBase> logger, IScheduleConfigurationProvider provider) : base(logger)
    {
        _provider = provider;
    }
