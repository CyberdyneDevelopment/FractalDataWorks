...
/// </summary>
public abstract class ListSchedulesEndpointBase : CrudListEndpoint<ListSchedulesRequest, ScheduleSummaryDto>
{
    ...
    // Why: returns a flat list — the base CrudListEndpoint applies skip/take and wraps the result
