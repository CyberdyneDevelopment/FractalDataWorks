...
The UI model root — pages, navigation and the render-agnostic seam beneath them.
...
| Type | Kind | Purpose |
|---|---|---|
| `PageTypes` | class | TypeCollection for all UI page assemblies. |

## Installation

```bash
dotnet add package Fdw.UI --prerelease
```
