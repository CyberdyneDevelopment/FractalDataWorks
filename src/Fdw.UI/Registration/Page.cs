...
// each page needing its own class. A page that DOES need behaviour (a computed permission, a conditional
...
public sealed class Page : PageBase
{
    ...
    public Page(string name, Type component, INavItem navItem, string? requiredPermission)
        : base(name, component, navItem, requiredPermission) { }
}
