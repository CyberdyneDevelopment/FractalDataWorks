...
/// <summary>
/// MessageLogging for <see cref="Navigation.Translators.FindMembersTranslator"/>.
/// </summary>
[MessageLoggingTypeCode("RCMD")]
public static partial class FindMembersTranslatorLog
{
    /// <summary>Trace: member lookup starting.</summary>
    [MessageLogging(EventId = 11092, Level = LogLevel.Trace,
        Message = "FindMembersTranslator finding members at '{filePath}' {line}:{column} (includeInherited={includeInherited})")]
    public static partial IGenericMessage Finding(ILogger logger, string filePath, int line, int column, bool includeInherited);
    ...
    [MessageLogging(EventId = 31001, Level = LogLevel.Error,
        Message = "FindMembersTranslator: document not found at '{filePath}'")]
    ...
    [MessageLogging(EventId = 91009, Level = LogLevel.Error,
        Message = "FindMembersTranslator: failed to load document at '{filePath}'")]
    ...
    [MessageLogging(EventId = 91003, Level = LogLevel.Error,
        Message = "FindMembersTranslator: failed to analyze document '{filePath}'")]
    ...
    [MessageLogging(EventId = 21021, Level = LogLevel.Error,
        Message = "FindMembersTranslator: symbol at {line}:{column} in '{filePath}' is not a type")]
    ...
    [MessageLogging(EventId = 11093, Level = LogLevel.Information,
        Message = "FindMembersTranslator found {count} member(s) in '{typeName}'")]
