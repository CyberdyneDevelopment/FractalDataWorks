...
/// </summary>
[TypeOption(typeof(SqliteDataResultCodes), "NoFieldsToProject", RestrictToCurrentCompilation = true)]
[ExcludeFromCodeCoverage]
public sealed class NoFieldsToProjectCode : SqliteDataResultCodeBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="NoFieldsToProjectCode"/> class.
    /// </summary>
    public NoFieldsToProjectCode()
        : base(21003, "NoFieldsToProject",
