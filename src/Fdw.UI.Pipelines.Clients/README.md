# Fdw.UI.Pipelines.Clients

The API client for the pipeline designer.
...
| Type | Kind | Purpose |
|---|---|---|
| `PipelineDesignerApiClient` | class | HTTP client implementation for the pipeline designer API. |

## Installation

```bash
dotnet add package Fdw.UI.Pipelines.Clients --prerelease
```
