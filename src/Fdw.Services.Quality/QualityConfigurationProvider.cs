...
public class QualityConfigurationProvider
{
    ...
    /// </summary>
    private readonly ImplementationConfigurationProviderBase<IQualityRuleImplementationConfiguration> _qualityRuleProvider;
    private readonly ImplementationConfigurationProviderBase<IDataSetAnnotationImplementationConfiguration> _annotationProvider;
    private readonly ImplementationConfigurationProviderBase<IEnvironmentImplementationConfiguration> _environmentProvider;
    private readonly ImplementationConfigurationProviderBase<IPromotionRequestImplementationConfiguration> _promotionRequestProvider;
    private readonly ImplementationConfigurationProviderBase<IGlossaryTermImplementationConfiguration> _glossaryTermProvider;
    ...
    #pragma warning restore MA0051
    {
        ...
        _qualityRuleProvider = new ImplementationConfigurationProviderBase<IQualityRuleImplementationConfiguration>(
            logger: null, gatewayProvider, dataStoreName, "quality");
        _annotationProvider = new ImplementationConfigurationProviderBase<IDataSetAnnotationImplementationConfiguration>(
            logger: null, gatewayProvider, dataStoreName, "catalog");
        _environmentProvider = new ImplementationConfigurationProviderBase<IEnvironmentImplementationConfiguration>(
            logger: null, gatewayProvider, dataStoreName, "quality");
        _promotionRequestProvider = new ImplementationConfigurationProviderBase<IPromotionRequestImplementationConfiguration>(
            logger: null, gatewayProvider, dataStoreName, "quality");
        _glossaryTermProvider = new ImplementationConfigurationProviderBase<IGlossaryTermImplementationConfiguration>(
            logger: null, gatewayProvider, dataStoreName, "catalog");
    }
