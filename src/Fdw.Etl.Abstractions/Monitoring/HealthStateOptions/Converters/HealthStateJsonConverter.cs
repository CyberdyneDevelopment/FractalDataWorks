...
namespace Fdw.Etl.Abstractions.Monitoring.HealthStateOptions.Converters;
...
/// bare name string and the full object shape so every health monitoring round-trip works over
