...
public sealed class DiscoveredField
{
    ...
    /// <summary>
    /// Gets the PostgreSQL data type (e.g., "integer", "character varying", "timestamp with time zone").
    /// </summary>
    ...
    /// <summary>
    /// Gets whether this column is an identity/serial column.
    /// </summary>
    public bool IsIdentity { get; init; }

    /// <summary>
    /// Gets whether this column is generated (ALWAYS).
    /// </summary>
    ...
    /// <summary>
    /// Gets the column description from pg_description.
    /// </summary>
