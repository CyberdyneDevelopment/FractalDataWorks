...
/// <c>Fdw.Abstractions.IServiceFactory</c> must not take an <c>IDomainServiceProvider</c> or an
...
/// </para>
/// <list type="number">
/// <item>A factory ctor-injecting its OWN collection's <c>IDomainServiceProvider</c> re-enters that
...
/// <c>IServiceScopeFactory.CreateScope().ServiceProvider.GetService&lt;IDomainServiceProvider&lt;...&gt;&gt;()</c>
/// and blocks on it — a raw-container service locator plus sync-over-async thread-pool-starvation freeze.</item>
/// </list>
/// <para>
/// A dependency wrapped in <c>Lazy&lt;IDomainServiceProvider&lt;...&gt;&gt;</c> defers resolution past
