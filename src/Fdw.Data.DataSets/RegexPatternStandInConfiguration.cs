...
/// <summary>The RegexPattern stand-in strategy body: values match a regular expression.</summary>
[ExcludeFromCodeCoverage]
[GenerateMapper]
[ManagedConfiguration(ServiceCategory = "DataSet", ServiceType = "RegexPatternStandIn")]
public sealed partial class RegexPatternStandInConfiguration
{
    ...
    /// <summary>Gets or sets the pattern every generated value matches.</summary>
