...
/// <summary>The DateRange stand-in strategy body: values are random dates in a range.</summary>
[ExcludeFromCodeCoverage]
[GenerateMapper]
[ManagedConfiguration(ServiceCategory = "DataSet", ServiceType = "DateRangeStandIn")]
public sealed partial class DateRangeStandInConfiguration
{
    ...
    /// <summary>Gets or sets the earliest date that can be generated.</summary>
    public DateTime FromDate { get; set; }

    /// <summary>Gets or sets the latest date that can be generated.</summary>
