...
/// <summary>One cell within a <see cref="DataSetSampleRowConfiguration"/>.</summary>
/// <remarks>
/// Value is nullable: a sample may deliberately leave a cell empty, which is different from the
/// cell not being part of the sample at all (no row for that field).
/// </remarks>
[ExcludeFromCodeCoverage]
[GenerateMapper]
[ManagedConfiguration(ServiceCategory = "DataSet", ServiceType = "DataSetSampleValue")]
public sealed partial class DataSetSampleValueConfiguration
{
    ...
    /// <summary>Gets or sets the sample row this value belongs to (FK to data.DataSetSampleRow.Id).</summary>
    public Guid DataSetSampleRowId { get; set; }

    /// <summary>Gets or sets the field this value is for.</summary>
    public Guid DataSetFieldId { get; set; }

    /// <summary>Gets or sets the value, or null for a deliberately empty cell.</summary>
