...
/// <summary>
/// A named set of hand-picked rows for a data set — the ones people actually mean when they argue
/// about a model, as distinct from generated stand-in values.
/// </summary>
[ExcludeFromCodeCoverage]
[GenerateMapper]
[ManagedConfiguration(ServiceCategory = "DataSet", ServiceType = "DataSetSample")]
public sealed partial class DataSetSampleConfiguration
{
    ...
    /// <summary>Gets or sets the data set this sample belongs to (FK to data.DataSetImplementation.Id).</summary>
    public Guid DataSetImplementationId { get; set; }

    /// <summary>Gets or sets the optional description of what this sample is for.</summary>
