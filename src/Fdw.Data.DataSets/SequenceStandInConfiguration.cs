...
/// <summary>The Sequence stand-in strategy body: values count up from a start value.</summary>
[ExcludeFromCodeCoverage]
[GenerateMapper]
[ManagedConfiguration(ServiceCategory = "DataSet", ServiceType = "SequenceStandIn")]
public sealed partial class SequenceStandInConfiguration
{
    ...
    /// <summary>Gets or sets the first value generated.</summary>
    public long StartValue { get; set; }

    /// <summary>Gets or sets how much each subsequent value increases by.</summary>
