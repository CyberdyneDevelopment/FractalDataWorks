...
/// <summary>The WeightedPick stand-in strategy body: values are drawn from a weighted option list.</summary>
/// <remarks>The options themselves live on <see cref="WeightedPickStandInValueConfiguration"/>.</remarks>
[ExcludeFromCodeCoverage]
[GenerateMapper]
[ManagedConfiguration(ServiceCategory = "DataSet", ServiceType = "WeightedPickStandIn")]
public sealed partial class WeightedPickStandInConfiguration
{
