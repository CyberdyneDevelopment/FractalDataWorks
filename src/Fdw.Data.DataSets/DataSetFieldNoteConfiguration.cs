...
/// <summary>
/// A freeform note attached to a DataSet field — operational observations, caveats,
/// or "while it is working" remarks visible to anyone inspecting the field definition.
/// </summary>
[ExcludeFromCodeCoverage]
[GenerateMapper]
[ManagedConfiguration( ServiceCategory = "DataSet",
    ServiceType = "DataSetFieldNote")]
public sealed partial class DataSetFieldNoteConfiguration
{
    /// <summary>Gets or sets the unique identifier for this note.</summary>
    public Guid Id { get; set; }

    /// <summary>Gets or sets the parent DataSetField identifier (FK to data.DataSetField.Id).</summary>
