# Fdw.Services.Multitenancy.Clients

The API client for tenant management.
...
| Type | Kind | Purpose |
|---|---|---|
| `TenantApiClient` | class | API client for multitenancy operations. |

## Installation

```bash
dotnet add package Fdw.Services.Multitenancy.Clients --prerelease
```

## Dependencies

`Fdw.Services.Multitenancy.Abstractions` · `Fdw.Web.Clients` · `Fdw.Web.Http.Authentication`
