...
The API client for schedule management.
...
| Type | Kind | Purpose |
|---|---|---|
| `ScheduleHttpClient` | class | HTTP client implementation for the scheduling service. |

## Installation

```bash
dotnet add package Fdw.Services.Scheduling.Clients --prerelease
```

## Dependencies

`Fdw.Services.Scheduling.Abstractions` · `Fdw.Web.Clients` · `Fdw.Web.Http.Authentication`
