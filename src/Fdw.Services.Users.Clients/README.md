# Fdw.Services.Users.Clients

The API client for user management.
...
| Type | Kind | Purpose |
|---|---|---|
| `UserApiClient` | class | API client for user management. |

## Installation

```bash
dotnet add package Fdw.Services.Users.Clients --prerelease
```

## Dependencies

`Fdw.Services.Users.Abstractions` · `Fdw.Web.Clients` · `Fdw.Web.Http.Authentication`
