...
public sealed partial class ExternalIdentityProvisionerBindingImplementationConfiguration
    : IExternalIdentityProvisionerBindingImplementationConfiguration
{
    /// <inheritdoc/>
