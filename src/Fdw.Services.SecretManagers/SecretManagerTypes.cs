    ...
    ISecretManagerType<ISecretManager, ISecretManagerServiceFactory<ISecretManager, ISecretManagerImplementationConfiguration>, ISecretManagerImplementationConfiguration>>
{
    ...
    static SecretManagerTypes()
    {
        ...
        Registration((builder, loggerFactory) =>
        {
            ...
            builder.Services.TryAddSingleton<ImplementationConfigurationProviderBase<ISecretManagerImplementationConfiguration>>(
                sp => sp.GetRequiredService<SecretManagerConfigurationProvider>());
            builder.Services.TryAddSingleton<IImplementationConfigurationProvider<ISecretManagerImplementationConfiguration>>(
                sp => sp.GetRequiredService<SecretManagerConfigurationProvider>());
            ...
            builder.Services.AddSingleton<IPlatformServiceProvider<ISecretManager, ISecretManagerImplementationConfiguration>>(
