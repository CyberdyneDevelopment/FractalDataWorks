    ...
    ISecretManagerType<ISecretManager, ISecretManagerServiceFactory<ISecretManager, ISecretManagerImplementationConfiguration>, ISecretManagerImplementationConfiguration>>
{
    ...
    static SecretManagerTypes()
    {
        ...
        Registration((builder, loggerFactory) =>
        {
            ...
            builder.Services.AddSingleton<ISecretManagerConfigurationProvider, SecretManagerConfigurationProvider>(sp => new SecretManagerConfigurationProvider(sp.GetRequiredService<ILogger<SecretManagerConfigurationProvider>>(), sp.GetRequiredService<IConfigurationGatewayProvider>(), SecretManagerTypes.ConfigurationConnection));
            ...
            // is both, but a consumer resolving IDomainServiceProvider<ISecretManager, …> — which is
            ...
            builder.Services.AddSingleton<IDomainServiceProvider<ISecretManager, ISecretManagerImplementationConfiguration>>(
                ...
                try
                {
                    ...
                    else
                    {
                        ServiceTypeLog.DomainHasNoConfigurationSource(
                            ...
                            typeof(IImplementationConfigurationProvider<ISecretManagerImplementationConfiguration>).ToString());
                    }
                }
                catch (Exception ex)
                {
