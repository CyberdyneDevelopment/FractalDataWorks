...
/// <c>ICredentialServiceImplementationConfiguration? Configuration</c> property populated on the read path.
/// </remarks>
public interface ICredentialServiceImplementationConfiguration : IImplementationConfiguration
{
