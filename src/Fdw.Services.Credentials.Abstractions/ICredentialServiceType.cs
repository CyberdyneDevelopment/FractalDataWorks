...
public interface ICredentialServiceType : IServiceType
{
    ...
    /// <c>CredentialServiceTypes</c>'s own <c>AddScoped</c> factory via <see cref="Register"/>, once
    ...
    /// construction used.
    /// </param>
    void Registration(Func<IServiceProvider, ICredentialServiceProvider?, ICredentialServiceConfigurationProvider?, ILogger<ICredentialServiceType>, IGenericResult> method);
    ...
    IGenericResult Register(IServiceProvider serviceProvider, ICredentialServiceProvider? domainProvider, ICredentialServiceConfigurationProvider? domainConfigurationProvider, ILogger<ICredentialServiceType> logger);
}
