...
public interface ICredentialServiceType : IServiceType
{
    ...
    /// </summary>
    /// <remarks>
    /// Called from <c>CredentialServiceTypes</c>'s own <c>AddScoped</c> factory — once per domain
    ...
    IGenericResult RegisterImplementationProvider(ICredentialServiceProvider domainProvider, IServiceProvider serviceProvider, ILogger logger);
}
