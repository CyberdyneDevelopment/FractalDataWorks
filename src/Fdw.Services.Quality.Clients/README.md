# Fdw.Services.Quality.Clients

The API client for data-quality rules and dashboards.
...
| Type | Kind | Purpose |
|---|---|---|
| `QualityApiClient` | class | API client for data quality management endpoints. |

## Installation

```bash
dotnet add package Fdw.Services.Quality.Clients --prerelease
```

## Dependencies

`Fdw.Services.Quality.Abstractions` · `Fdw.Web.Clients` · `Fdw.Web.Http.Authentication`
