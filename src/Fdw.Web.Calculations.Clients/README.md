# Fdw.Web.Calculations.Clients

The API client for calculations and formulas.
...
| Type | Kind | Purpose |
|---|---|---|
| `CalculationApiClient` | class | API client for calculation management and execution endpoints. |

## Installation

```bash
dotnet add package Fdw.Web.Calculations.Clients --prerelease
```

## Dependencies

`Fdw.Web.Calculations.Clients.Abstractions` · `Fdw.Web.Clients` · `Fdw.Web.Endpoints` · `Fdw.Web.Http.Authentication`
