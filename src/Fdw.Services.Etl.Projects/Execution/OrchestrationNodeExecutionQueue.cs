...
/// <summary>
/// Channel-based bounded queue for orchestration node execution requests.
...
public sealed class OrchestrationNodeExecutionQueue
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="OrchestrationNodeExecutionQueue"/> with the specified capacity.
    /// </summary>
    /// <param name="capacity">
    ...
    /// </param>
    public OrchestrationNodeExecutionQueue(int capacity = 100)
    {
    ...
    /// <summary>
    /// Enqueues an orchestration node execution request.
    /// </summary>
    ...
    /// Why internal: only OrchestrationNodeOrchestratorBackgroundService (same assembly) reads from the
    /// channel. Endpoints should never read from the queue directly.
    /// </summary>
    internal ChannelReader<OrchestrationNodeExecutionRequest> Reader => _channel.Reader;
}
