# Fdw.Services.Connections.Clients

The API client for connection management.
...
| Type | Kind | Purpose |
|---|---|---|
| `ConnectionApiClient` | class | API client for connection management endpoints. |

## Installation

```bash
dotnet add package Fdw.Services.Connections.Clients --prerelease
```

## Dependencies

`Fdw.Services.Connections.Abstractions` · `Fdw.Web.Clients` · `Fdw.Web.Endpoints` · `Fdw.Web.Http.Authentication`
