...
internal static partial class OidcLog
{
    ...
    internal static partial IGenericMessage Challenging(ILogger logger, string issuer);
    ...
    internal static partial IGenericMessage Completed(ILogger logger, string issuer);
    ...
    internal static partial IGenericMessage StateMissing(ILogger logger, string issuer);
    ...
    internal static partial IGenericMessage IssuerMismatch(
        ILogger logger, string expected, string actual);
    ...
    internal static partial IGenericMessage ExchangeRefused(
        ILogger logger, string issuer, string statusCode);
    ...
    internal static partial IGenericMessage NoIdToken(ILogger logger, string issuer);
    ...
    internal static partial IGenericMessage NonceMismatch(ILogger logger, string issuer);
    ...
    internal static partial IGenericMessage SubjectClaimMissing(
        ILogger logger, string issuer, string claim);
}
