# Fdw.Web.Clients.Wasm

Blazor WebAssembly client infrastructure, including browser-side caching.
...
```bash
dotnet add package Fdw.Web.Clients.Wasm --prerelease
```

## Dependencies

`Fdw.MessageLogging.Abstractions` · `Fdw.Web.Clients.Abstractions`
