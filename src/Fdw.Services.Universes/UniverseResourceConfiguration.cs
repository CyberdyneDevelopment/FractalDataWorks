...
/// </remarks>
[GenerateMapper]
public sealed partial class UniverseResourceConfiguration : IGenericConfiguration
{
    ...
    public string SectionName => "UniverseResources";

    /// <summary>Gets the structural discriminator.</summary>
    public string ServiceType => "UniverseResource";
