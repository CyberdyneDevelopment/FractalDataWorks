...
The API client for the agent action review queue.
...
| Type | Kind | Purpose |
|---|---|---|
| `AgentActionClient` | class | API client for agent action review queue endpoints. |

## Payloads

| Type | Kind | Purpose |
|---|---|---|
| `AgentActionPayload` | class | Data transfer object for an agent action review item. |

## Installation

```bash
dotnet add package Fdw.Agents.Clients --prerelease
```
