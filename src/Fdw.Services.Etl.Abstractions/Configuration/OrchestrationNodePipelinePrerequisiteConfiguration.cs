...
/// <summary>
/// ManagedConfiguration for the <c>pipe.OrchestrationNodePipelinePrerequisite</c> table.
/// Records a directed prerequisite edge: a Pipeline within a node cannot start
/// until its prerequisite Pipeline within the same node has completed successfully.
/// </summary>
/// <remarks>
/// <para>
/// Prerequisites are validated at save time to ensure:
/// (1) Both pipelines belong to the same node.
/// (2) The prerequisite graph is acyclic (topological sort).
/// </para>
/// <para>
/// Replaces <c>StepPipelinePrerequisiteConfiguration</c> (v1 pipe.StepPipelinePrerequisite table).
/// </para>
/// </remarks>
[ExcludeFromCodeCoverage]
[ManagedConfiguration( ServiceCategory = "Orchestration",
    ServiceType = "NodePipelinePrerequisite")]
public sealed partial class OrchestrationNodePipelinePrerequisiteConfiguration : IGenericConfiguration
{
    ...
    public string ServiceType => "NodePipelinePrerequisite";
