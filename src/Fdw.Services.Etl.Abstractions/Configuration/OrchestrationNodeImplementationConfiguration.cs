...
public sealed partial class OrchestrationNodeImplementationConfiguration
    : IOrchestrationNodeImplementationConfiguration
{
    /// <inheritdoc/>
    ...
    public IList<OrchestrationNodeImplementationConfiguration> Children { get; set; } = [];
