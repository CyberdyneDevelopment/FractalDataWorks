...
public interface IEtlPipelineType : IServiceType
{
    ...
    /// <c>EtlPipelineTypes</c>'s own <c>AddScoped</c> factory via <see cref="Register"/>, once per
    ...
    /// construction used.
    /// </param>
    void Registration(Func<IServiceProvider, IEtlPipelineProvider?, IPipelineConfigurationProvider?, ILogger<IEtlPipelineType>, IGenericResult> method);
    ...
    IGenericResult Register(IServiceProvider serviceProvider, IEtlPipelineProvider? domainProvider, IPipelineConfigurationProvider? domainConfigurationProvider, ILogger<IEtlPipelineType> logger);
}
