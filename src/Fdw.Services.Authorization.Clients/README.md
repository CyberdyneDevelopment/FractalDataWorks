# Fdw.Services.Authorization.Clients

The API client for role and permission management.
...
| Type | Kind | Purpose |
|---|---|---|
| `RoleApiClient` | class | API client for role and permission management. |

## Installation

```bash
dotnet add package Fdw.Services.Authorization.Clients --prerelease
```

## Dependencies

`Fdw.Services.Authorization.Abstractions` · `Fdw.Web.Clients` · `Fdw.Web.Http.Authentication`
