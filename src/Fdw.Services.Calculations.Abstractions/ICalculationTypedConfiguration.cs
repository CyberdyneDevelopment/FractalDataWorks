...
/// Connection's <c>IConnectionImplementationConfiguration</c>). A property typed as <see cref="IGenericConfiguration"/>
...
/// </remarks>
public interface ICalculationTypedConfiguration : IImplementationConfiguration
{
