...
/// <summary>
/// Maps to <c>dataverse.SavedView</c> — a stored visualisation of a data set.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// Why there is no dataverse id: membership lives in <c>dataverse.DataverseResource</c>, the same as
...
public partial class SavedViewImplementationConfiguration
    : ISavedViewImplementationConfiguration
{
    /// <inheritdoc/>
