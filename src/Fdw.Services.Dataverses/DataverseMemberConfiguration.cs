...
/// <summary>
/// Maps to <c>dataverse.DataverseMember</c> — a person's membership of a dataverse.
/// </summary>
/// <remarks>
...
/// </remarks>
[GenerateMapper]
public sealed partial class DataverseMemberConfiguration : IGenericConfiguration
{
    ...
    public string SectionName => "DataverseMembers";

    /// <summary>Gets the structural discriminator.</summary>
    public string ServiceType => "DataverseMember";
