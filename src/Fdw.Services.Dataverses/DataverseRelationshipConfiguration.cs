...
/// <summary>
/// Maps to <c>dataverse.DataverseRelationship</c> — a declared relationship between two data sets,
/// drawn as an edge on the dataverse map.
/// </summary>
/// <remarks>
...
/// </remarks>
[GenerateMapper]
public sealed partial class DataverseRelationshipConfiguration : IGenericConfiguration
{
    ...
    public string SectionName => "DataverseRelationships";

    /// <summary>Gets the structural discriminator.</summary>
    public string ServiceType => "DataverseRelationship";
