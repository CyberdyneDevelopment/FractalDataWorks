...
/// <summary>
/// Maps to <c>dataverse.Note</c> — an observation someone leaves on a resource.
/// </summary>
/// <remarks>
/// <para>
...
/// </remarks>
[GenerateMapper]
public sealed partial class NoteImplementationConfiguration
    : INoteImplementationConfiguration
{
    /// <inheritdoc/>
    ...
    /// <summary>
    /// Gets or sets the dataverse the note was raised in, when there is one. A note may be left on
