...
/// <summary>
/// Maps to <c>dataverse.Dataverse</c> — a collaborative data project.
/// </summary>
/// <remarks>
/// <para>
/// A Dataverse is the root of the collaboration hierarchy: members join it, resources belong to
...
/// discriminator — the same as <c>OrchestrationNodeImplementationConfiguration</c> and its Stage/Step siblings.
/// </para>
/// </remarks>
[ExcludeFromCodeCoverage]
[GenerateMapper]
[ManagedConfiguration(ServiceCategory = "Dataverse")]
public partial class DataverseImplementationConfiguration
    : IDataverseImplementationConfiguration
{
    /// <inheritdoc/>
    ...
    /// <summary>Gets or sets the members of this dataverse.</summary>
    public IList<DataverseMemberConfiguration> Members { get; set; } = [];

    /// <summary>Gets or sets the resources attached to this dataverse.</summary>
    public IList<DataverseResourceConfiguration> Resources { get; set; } = [];

    /// <summary>Gets or sets the declared relationships between this dataverse's data sets.</summary>
    public IList<DataverseRelationshipConfiguration> Relationships { get; set; } = [];
