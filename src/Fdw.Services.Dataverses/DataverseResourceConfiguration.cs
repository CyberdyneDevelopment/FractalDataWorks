...
/// <summary>
/// Maps to <c>dataverse.DataverseResource</c> — a resource attached to a dataverse.
/// </summary>
/// <remarks>
/// <para>
/// Why <see cref="Relationship"/> exists: a dataverse owns the data sets it sketched but merely
/// uses a shared connection. Without the distinction, "what does archiving a dataverse do" has no
...
/// </remarks>
[GenerateMapper]
public sealed partial class DataverseResourceConfiguration : IGenericConfiguration
{
    ...
    public string SectionName => "DataverseResources";

    /// <summary>Gets the structural discriminator.</summary>
    public string ServiceType => "DataverseResource";
    ...
    /// <summary>Gets or sets how the dataverse relates to the resource: Owns, Uses or Produces.</summary>
