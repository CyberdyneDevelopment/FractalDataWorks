...
public sealed class DefaultAuthorizationServiceTests
{
    ...
    private static ImplementationConfigurationProviderBase<T, IImplementationConfiguration, TCommand> CreateProviderMock<T, TCommand>()
    ...
    {
        return new Mock<ImplementationConfigurationProviderBase<T, IImplementationConfiguration, TCommand>>(
            MockBehavior.Loose,
            NullLogger<ImplementationConfigurationProviderBase<T, IImplementationConfiguration, TCommand>>.Instance,
