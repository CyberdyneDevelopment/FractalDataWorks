...
public sealed class ChainedExternalIdentityProvisionerTests
{
    ...
    private static ChainedExternalIdentityProvisioner BuildSut(
        ...
        Mock<IFdwServiceProvider<IExternalIdentityProvisioner, ExternalIdentityProvisionerConfiguration>> providerMock)
    {
    ...
    public async Task MatchShortCircuitsBeforeLaterSteps()
    {
        ...
        var providerMock = new Mock<IFdwServiceProvider<IExternalIdentityProvisioner, ExternalIdentityProvisionerConfiguration>>(MockBehavior.Strict);
