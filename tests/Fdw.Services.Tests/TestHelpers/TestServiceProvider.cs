...
public sealed class TestServiceProvider
    : PlatformServiceProviderBase<
          ...
          IImplementationConfigurationProvider<TestConfiguration>>
{
    ...
    public TestServiceProvider(
        ...
        ILogger<PlatformServiceProviderBase<IGenericService, TestConfiguration, IServiceFactory<IGenericService>, IImplementationConfigurationProvider<TestConfiguration>>> logger)
